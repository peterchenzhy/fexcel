...
(function (a) {
    ...
    a.jqx.scheduler.recurrencePattern = function () {
                ...
                case"monthly":
                    if (c.bynweekday.length > 0) {
                        ...
                        for (var y = 0; y < c.bynweekday.length; y++) {
                            var q = c.bynweekday[y][0], x = c.bynweekday[y][1];
                            if (x < 0) {
                                z = m + (x + 1) * 7;
        ...
        c.init = function (j) {
            ...
            if (f.byweekday != undefined) {
                var h = {Sunday: 0, Monday: 1, Tuesday: 2, Wednesday: 3, Thursday: 4, Friday: 5, Saturday: 6};
                c.weekDays = {};
    ...
    a.jqx.ICalRule = function (u, n) {
        ...
        var h = m(1, 29), g = m(1, 30), P = m(1, 31), O = m(1, 32);
        ...
        if (!Object.keys) {
            Object.keys = (function () {
                var k = Object.prototype.hasOwnProperty, v = !({toString: null}).propertyIsEnumerable("toString"),
        ...
        this.origOptions = {};
        var E = [], w = Object.keys(this.options), p = Object.keys(d);
...
(function (a) {
    a.extend(a.jqx._jqxScheduler.prototype, {
        _getexportcolor: function (l) {
            ...
            var x = this.exportSettings.serverURL;
            var f = this.exportSettings.characterSet;
            var B = this.exportSettings.fileName;
            var G = this.exportSettings.ICSXWRCALNAME;
            var r = this.exportSettings.ICSXWRCALDESC;
            if (B === undefined) {
                B = "jqxScheduler"
            }
            var p = this;
            if (v == "ical" || v == "ics") {
                if (p._resources.length > 1 && B && p.resourcesInMultipleICSFiles) {
                    var s = this.getAppointments();
                    for (var D = 0; D < p._resources.length; D++) {
                        var c = p._resources[D];
                        var u = new Array();
                        ...
                        var b = new Blob([o], {type: "application/calendar"});
                        if (saveAs) {
                            saveAs(b, B + "_" + c + ".ics")
                        } else {
                            if (window.jqxSaveAs) {
                                window.jqxSaveAs(b, B + "_" + c + ".ics")
                            }
                        }
                    }
                } else {
                    ...
                    if (saveAs) {
                        ...
                        if (window.jqxSaveAs) {
                            window.jqxSaveAs(b, B + ".ics")
                        }
                    }
                }
                return
            }
            var s = this.getDataAppointments();
            var z = new Array();
            var E = {};
            var q = {};
            ...
            var F = "column";
            var d = 1;
            var y = a(this.columns.records[0].element);
            var n = 0;
            a.each(this.appointmentDataFields, function (j, m) {
                ...
                E[m].width = 100;
                E[m].formatString = "";
                E[m].localization = p.schedulerLocalization;
                if (j == "from" || j == "to") {
                    E[m].type = "date";
                    E[m].formatString = p.exportSettings.dateTimeFormatString
                } else {
                    E[m].type = "string"
                }
                E[m].cellsAlign = "left";
                ...
                k = "cell" + e;
                F = "column" + d;
                if (v == "html" || v == "xls" || v == "pdf") {
                    var i = function (I, Q, P, J, O, L, K, M, N) {
                        q[I] = {};
                        if (Q == undefined) {
                            return
                        }
                        q[I]["font-size"] = Q.css("font-size");
                        q[I]["font-weight"] = Q.css("font-weight");
                        q[I]["font-style"] = Q.css("font-style");
                        q[I]["background-color"] = p._getexportcolor(Q.css("background-color"));
                        q[I]["color"] = p._getexportcolor(Q.css("color"));
                        q[I]["border-color"] = p._getexportcolor(Q.css("border-top-color"));
                        if (P) {
                            q[I]["text-align"] = "left"
                        } else {
                            q[I]["text-align"] = "left";
                            ...
                            if (K == "from" || K == "to") {
                                q[I]["dataType"] = "date";
                                q[I]["formatString"] = p.exportSettings.dateTimeFormatString
                            }
                        }
                        if (v == "html" || v == "pdf") {
                            q[I]["border-top-width"] = Q.css("border-top-width");
                            q[I]["border-left-width"] = Q.css("border-left-width");
                            q[I]["border-right-width"] = Q.css("border-right-width");
                            q[I]["border-bottom-width"] = Q.css("border-bottom-width");
                            q[I]["border-top-style"] = Q.css("border-top-style");
                            q[I]["border-left-style"] = Q.css("border-left-style");
                            q[I]["border-right-style"] = Q.css("border-right-style");
                            q[I]["border-bottom-style"] = Q.css("border-bottom-style");
                            if (P) {
                                if (n == 0) {
                                    q[I]["border-left-width"] = Q.css("border-right-width")
                                }
                                q[I]["border-top-width"] = Q.css("border-right-width");
                                q[I]["border-bottom-width"] = Q.css("border-bottom-width")
                            } else {
                                if (n == 0) {
                                    q[I]["border-left-width"] = "1px"
                                }
                                q[I]["border-right-width"] = "1px"
                            }
                        }
                        if (P) {
                            E[m].style = I
            ...
            var w = a.jqx.dataAdapter.ArrayExporter(s, E, q, x);
            if (B == null) {
                this._renderrows();
                var t = w.exportTo(v);
                setTimeout(function () {
            ...
            var h = parseInt(b.slice(1), 16), c = g < 0 ? 0 : 255, i = g < 0 ? g * -1 : g, e = h >> 16,
                d = h >> 8 & 255, j = h & 255;
            ...
            if (e == undefined) {
                return b ? {r: parseInt(b[1], 16), g: parseInt(b[2], 16), b: parseInt(b[3], 16), toString: d} : null
            }
            if (e > 1) {
                e = 1
            } else {
            ...
            return {background: e, color: c, border: d}
            ...
            return {background: c, color: f, border: e}
            ...
            var o = function (H, A) {
                ...
                G.jqxRadioButton({rtl: h.rtl, groupName: "end" + A, theme: h.theme, width: 200, checked: true});
                ...
                F.jqxRadioButton({rtl: h.rtl, groupName: "end" + A, theme: h.theme, width: 60, checked: false});
                ...
                t.jqxRadioButton({rtl: h.rtl, groupName: "end" + A, theme: h.theme, width: 60, checked: false});
            ...
            var q = function () {
                ...
                for (var aw = 0; aw < 7; aw++) {
                    ...
                    B.jqxCheckBox({rtl: h.rtl, checked: Y, width: 50, theme: h.theme});
                ...
                al.jqxRadioButton({rtl: h.rtl, groupName: "month", width: 60, checked: true, theme: h.theme});
                ...
                G.jqxRadioButton({groupName: "month", width: 25, checked: false, theme: h.theme});
                ...
                af.jqxRadioButton({rtl: h.rtl, groupName: "year", width: 25, checked: true, theme: h.theme});
                ...
                C.jqxRadioButton({rtl: h.rtl, groupName: "year", width: 25, checked: false, theme: h.theme});
            ...
            d.jqxCheckBox({width: "100%", theme: h.theme});
            g.hide();
            ...
            this.addHandler(k, "change", function (u) {
                ...
                var s = function () {
                    ...
                    if (!h.isTouchDevice()) {
                        p.jqxWindow({height: 150});
                        p.jqxWindow({height: i[0].scrollHeight + 40})
                    }
                }()
            })
        }, _initMenu: function () {
            ...
            if (this.host.jqxMenu) {
                ...
                var d = new Array();
                d.push({label: this.schedulerLocalization.contextMenuEditAppointmentString, id: "editAppointment"});
                d.push({label: this.schedulerLocalization.contextMenuCreateAppointmentString, id: "createAppointment"});
                var b = {
                    rtl: this.rtl,
                ...
                c._raiseEvent("contextMenuCreate", {menu: c.menu, settings: b});
                this.menu.jqxMenu(b)
            }
            ...
            if (m.editDialogFields && m.editDialogFields.resourceContainer && m._resources.length > 0) {
                ...
                m.editDialogFields.resource.jqxDropDownList({source: e, selectedIndex: 0, autoDropDownHeight: r});
                if (!b) {
            ...
            if (m._editDialog == null) {
                ...
                a(q).jqxWindow({
                    ...
                    initContent: function () {
                        ...
                        U.jqxInput({height: 25, rtl: m.rtl, width: "100%", theme: m.theme});
                        ...
                        T.jqxInput({height: 25, rtl: m.rtl, width: "100%", theme: m.theme});
                        ...
                        ai.jqxCheckBox({rtl: m.rtl, width: 25, theme: m.theme});
                        ...
                        m.addHandler(t, "change", function (i) {
                            if (i.args.checked) {
                                S.jqxDateTimeInput({showTimeButton: false, formatString: m.editDialogDateFormatString});
                                aq.jqxDateTimeInput({showTimeButton: false, formatString: m.editDialogDateFormatString})
                            } else {
                                S.jqxDateTimeInput({
                                    showTimeButton: true,
                                    formatString: m.editDialogDateTimeFormatString
                        ...
                        var u = new Array();
                        u.push({displayName: m.schedulerLocalization.editDialogSelectTimeZoneString, id: null});
                        ...
                        D.jqxInput({rtl: m.rtl, height: 40, width: "100%", theme: m.theme});
                        ...
                        m.addHandler(s, "click", function () {
                            ...
                            m._raiseEvent("appointmentChange", {appointment: m.editAppointment.boundAppointment});
                            m._renderrows();
                            q.jqxWindow("close");
                            m.overlay.hide()
                        });
                        m.addHandler(aB, "click", function () {
                            ...
                            m.changedAppointments[aE.id] = {type: "Update", appointment: aE.boundAppointment};
                            m._raiseEvent("appointmentChange", {appointment: aE.boundAppointment});
                            m._renderrows();
                            q.jqxWindow("close");
                            m.overlay.hide()
                        });
                        ...
                        q.jqxWindow({height: H[0].scrollHeight + 40})
                    }
                });
                m._editDialog = q
            }
            ...
            m.addHandler(m._editDialog, "open", function (t) {
                ...
                setTimeout(function () {
                    ...
                    m._raiseEvent("editDialogOpen", {dialog: m._editDialog, fields: m.editDialogFields, appointment: v})
                });
                var s = function () {
                    setTimeout(function () {
                        if (!c) {
                ...
                if (0 == m.dialogOpenings && !b) {
                    m.dialogOpenings++;
                    if (!m.isTouchDevice()) {
                        m._editDialog.jqxWindow({height: 150});
                        m._editDialog.jqxWindow({height: a(m._editDialog.children())[1].scrollHeight + 40})
                    }
            ...
            if (g) {
                ...
                f._editDialog.jqxWindow({draggable: false, maxWidth: f.host.width(), maxHeight: f.host.height()});
                f._editDialog.jqxWindow({width: f.host.width(), height: f.host.height()});
            ...
            var c = function () {
                ...
                p.repeatEndNever.jqxRadioButton({checked: true});
                p.repeatEndAfter.jqxRadioButton({checked: false});
                ...
                if (f.editDialogFields.weekly) {
                    ...
                    for (var m = 0; m < o.repeatDays.length; m++) {
                        if (m == 1) {
                            o.repeatDays[m].jqxCheckBox({checked: true})
                        } else {
                            o.repeatDays[m].jqxCheckBox({checked: false})
                        }
                    }
                ...
                if (f.editDialogFields.monthly) {
                    ...
                    n.repeatDayOfWeekBool.jqxRadioButton({checked: false});
                    n.repeatDayOfWeekType.jqxDropDownList("selectIndex", 0);
                    n.repeatMonthDayBool.jqxRadioButton({checked: true});
                ...
                if (f.editDialogFields.yearly) {
                    ...
                    k.repeatDayOfWeekBool.jqxRadioButton({checked: false});
            ...
            var b = function (j) {
                ...
                if (r.count != 1000) {
                    n.repeatEndNever.jqxRadioButton({checked: false});
                    n.repeatEndAfter.jqxRadioButton({checked: true});
                    n.repeatEndAfterValue.val(r.count)
                } else {
                    if (r.to.year() != 9999) {
                        n.repeatEndOn.jqxRadioButton({checked: true});
                        n.repeatEndOnValue.val(r.to.toDate())
                    } else {
                        n.repeatEndNever.jqxRadioButton({checked: true})
                    }
                }
                ...
                switch (p) {
                    ...
                    case 3:
                        ...
                        if (r.bymonthday && r.bymonthday.length > 0) {
                            u.repeatMonthDayBool.jqxRadioButton({checked: true});
                            u.repeatMonthDay.val(r.day)
                        } else {
                            u.repeatDayOfWeekBool.jqxRadioButton({checked: true});
                            var s = r.bynweekday;
                            var m = s[0][0];
                            m++;
                            if (m == 7) {
                    ...
                    case 4:
                        ...
                        if (!r.byyearday || (r.byyearday && r.byyearday.length == 0)) {
                            ...
                            t.repeatDayOfWeekBool.jqxRadioButton({checked: true});
                            var s = r.bynweekday;
                            var m = s[0][0];
                            m++;
                            if (m == 7) {
    ...
    a.jqx.scheduler.dataView = function (b) {
        ...
        this.databind = function (c, i) {
            ...
            if (j) {
                ...
                e = new a.jqx.dataAdapter(c, {autoBind: false})
            }
            var f = function (o) {
                e.recordids = [];
                e.records = new Array();
